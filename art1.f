...
C     THIS VERSION READS STDIN FOR INPUT AND
...
C     A.OUT < FORT.25 | ASA > OUTPUT.TXT
C     CORRECTS BRANCHING ERROR IN EXPONENTIAL ROUTINE
C     THIS VERSION DOES NOT INITIALIZE THE ARRAYS AR1 AND AR2
