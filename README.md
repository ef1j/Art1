...
The "exponential" code contains several bugs in the archival listing: the lines between statement 708 up to 712 are never executed. Changing S.0320 in the  listing to `IF(AKSIG) 704, 724, 710` seems to fix the issue. [5]
